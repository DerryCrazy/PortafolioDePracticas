...
# Definimos una clase abstracta llamada Animal que sirve como base para otras clases.
# Utilizamos el módulo `abc` para definir métodos abstractos que deben ser implementados por las clases hijas.
